...
### `r emo::ji("heavy_large_circle")` How do we transform our data?<br>
...
You'll find some files that you need for today's class in our [`week_03_class`](https://github.com/UD-PCS-Foundations-of-R-Spring-2022/week_03_class) repository. Go to our [course organization](https://github.com/UD-PCS-Foundations-of-R-Spring-2022) and clone the [`week_03_class`](https://github.com/UD-PCS-Foundations-of-R-Spring-2022/week_03_class) file to your repository.
...
<br>
<br>
# `r emo::ji("clipboard")` [Survey](https://docs.google.com/forms/d/e/1FAIpQLSc6vvHuDcp61MZhhutDypyh4XP0Mf78GYDMmxNqR_8e1uqstg/viewform)
<br>
<br>
<br>
*If the link above is not working, copy this into your browser.*
```{r, eval=FALSE}
https://docs.google.com/forms/d/e/1FAIpQLSc6vvHuDcp61MZhhutDypyh4XP0Mf78GYDMmxNqR_8e1uqstg/viewform
```
]
